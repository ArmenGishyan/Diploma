...
public:
    ...
    virtual GGraphicsItem* parseShape(QStringList str) const = 0;
    //virtual QString convertAsText() const = 0;
...
public:
    ...
    GGraphicsRectItem* parseShape(QStringList str) const override;
...
public:
    ...
    QRectF boundingRect() const override;
    GGraphicsPointItem* parseShape(QStringList str) const override;
    void paint(QPainter *painter, const QStyleOptionGraphicsItem *option, QWidget *widget = nullptr) override;
...
public:
    ...
    void changeSize(const QPoint& points) override;
    QRectF boundingRect() const override;
    GGraphicsLineItem* parseShape(QStringList str) const override;
    void paint(QPainter * painter, const QStyleOptionGraphicsItem * option, QWidget * widget = nullptr) override;
